...
sendAutoResponse() {
    ...
    // This "shouts" the message so the Content Script can hear it
    window.postMessage(messageData, "*"); 
    
    this.logEntry(`Triggered: ${this.config.customResponse}`, 'success');
}

sendEmojiReaction() {
    this.logEntry(`Emoji requested: ${this.config.selectedEmoji}`, 'response');

    // FIX: Send emoji command to background
